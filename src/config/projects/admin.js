export default {
    ...
    routeGroups: [
        { module: "招生宝", routes: [{ label: "招生宝", path: "/recruit/templateLib" }] },
        { module: "在线商城", routes: [{ label: "在线商城", path: "/goods/index" }] },
        { module: "转介绍", routes: [{ label: "转介绍", path: "/promotion/promoteList" }] },
        { module: "优惠券", routes: [{ label: "优惠券", path: "/activity/coupon" }] },
        { module: "卡券管理", routes: [{ label: "卡券管理", path: "/order/index" }] },
        { module: "分佣推广", routes: [{ label: "分佣推广", path: "/distribution/setup" }] },
        { module: "商城数据", routes: [{ label: "商城数据", path: "/data/index" }] },
        { module: "商城设置", routes: [{ label: "商城设置", path: "/other/index" }] },
        { module: "小程序预览", routes: [{ label: "小程序预览（已交接）", path: "/preview/minp" }] },
    ],
};
